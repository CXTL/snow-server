...
//
//
//    public MongoDBQueryTool(DatasourceDto jobDatasource) throws IOException {
...
//    }
//
//    private void getDataSource(DatasourceDto jobDatasource) throws IOException {
//        if (StringUtils.isBlank(jobDatasource.getUsername()) && StringUtils.isBlank(jobDatasource.getJdbcPassword())) {
//            connection = new MongoClient(new MongoClientURI(jobDatasource.getUrl()));
//        } else {
//            MongoCredential credential = MongoCredential.createCredential(jobDatasource.getUsername(), jobDatasource.getDatabaseName(), jobDatasource.getJdbcPassword().toCharArray());
//            connection = new MongoClient(parseServerAddress(jobDatasource.getUrl()), Arrays.asList(credential));
//        }
